...
let shop_Items_El = document.querySelector('.shop_items');
...
function renderItemsNewArrival() {
  newArrival_items.forEach((item ,idx) => {
    ...
    itemEl.classList.add('row', 'product-all' , 'hover-img' , 'newArrival' );
    ...
    shop_Items_El.appendChild(itemEl);
  });
}
...
function renderItemsAdditional() {
  Additional_items.forEach((item ,idx) => {
    const itemEl = document.createElement('div');
    itemEl.classList.add('row', 'product-all' , 'hover-img' , 'Additional' );
...
function renderItemsShoes() {
  Shoes_items.forEach((item ,idx) => {
    const itemEl = document.createElement('div');
    itemEl.classList.add('row', 'product-all' , 'hover-img' , 'Shoes' );
...
function renderItemsPants() {
  Pants_items.forEach((item ,idx) => {
    const itemEl = document.createElement('div');
    itemEl.classList.add('row', 'product-all' , 'hover-img' , 'Pants' );
